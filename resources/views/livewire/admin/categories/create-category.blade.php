<div>
    ...
    <form wire:submit="save">
        <div>
            <x-input label="Category Name *" hint="Insert category name" wire:model="form.name" />
        </div>

        <div class="mt-4">
            <x-textarea label="Category description *" hint="Insert category name" wire:model="form.description" />
        </div>
